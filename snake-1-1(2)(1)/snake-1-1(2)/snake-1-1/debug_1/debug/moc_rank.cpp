...
#include <memory>
#include "../../project_1_3_2  just for save/rank.h"
...
QT_MOC_LITERAL(1, 5, 13), // "main_win_show"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "rank\0main_win_show\0"
};
...
void rank::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (rank::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&rank::main_win_show)) {
                *result = 0;
                return;
            }
        }
