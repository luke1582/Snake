...
#include <memory>
#include "../project_1_3_2  just for save/gamewidget.h"
...
QT_MOC_LITERAL(1, 11, 9), // "gameClose"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 9) // "game_exit"

    },
    "GameWidget\0gameClose\0\0game_exit"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::gameClose)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GameWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::game_exit)) {
                *result = 1;
                return;
            }
        }
